<main>
     ...
     <div class="productos">
         <a href="index.php"><img src="img/entrantes.jpeg" alt="Entrantes">
             <h3>Entrantes</h3>
         </a>
         <a href="index.php"><img src="img/principales.jpeg" alt="Platos principales">
             <h3>Platos principales</h3>
         </a>
     </div>
     <div class="productos">
         <a href="index.php"><img src="img/postres.jpeg" alt="Postres">
             <h3>Postres</h3>
         </a>
